...
public class MenuUtils {
    ...
    public MenuUtils(TooManyTrees main) { this.main = main; }
    ...
    public static void tutorialMenu(Player player) {
        ...
        meta.setTitle("Welcome to TooManyTrees!");
        ...
        pages.add(ChatColor.translateAlternateColorCodes('&',
                "      &7&lWelcome to:" + "\n" +
                        ...
                        "This guide book will show you everything you need to know about tmt! Happy reading!" + "\n" +
                        "" + "\n" +
                        " - ThirtyVirus" + "\n" +
                        "" + "\n" +
        ...
        pages.add(ChatColor.translateAlternateColorCodes('&',
                "&c&lIn-Inventory&r" + "\n" +
                        ...
                        "" + "\n" +
                        "Use &c'/tmt inv'&r to sort your personal inventory." + "\n" +
                        "" + "\n" +
